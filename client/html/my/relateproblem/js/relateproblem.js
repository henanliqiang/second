...
var vm = new Vue({
    ...
    methods: {
        ...
        // 获取店铺信息详情
        userProblem: function(type) {
            apps.axget(
                "commonProblemController/selectCommonProblemList", {},
                function(data) {
                    ...
                    if (vm.pageNo == 1) {
                        vm.problem_data.problemList = [];
                        data.datas.forEach(function(item) {
                            if (item) {
                                vm.problem_data.problemList.push(item);
                            }
                        });
        ...
        details: function(problemId) {
            // 相关问题详情
            jumpUrl.details({ problemId: problemId });
        },
    },
});
